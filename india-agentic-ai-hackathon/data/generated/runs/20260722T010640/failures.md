...
- languages: `{'as': 3, 'bn': 3, 'brx': 3, 'doi': 3, 'en': 3, 'gu': 3, 'hi': 3, 'kn': 3, 'kok': 3, 'ks': 3, 'mai': 3, 'ml': 3, 'mni': 3, 'mr': 3, 'ne': 3, 'or': 3, 'pa': 3, 'sa': 3, 'sat': 3, 'sd': 3, 'ta': 3, 'te': 3, 'ur': 3}`
- doc_types: `{'asha_worker_note': 8, 'automated_sms': 10, 'discharge_summary': 6, 'er_triage_notes': 4, 'hospital_billing': 8, 'insurance_claim': 2, 'lab_report': 3, 'opd_slip': 3, 'phc_register': 6, 'prescription': 7, 'radiology_report': 4, 'referral_letter': 5, 'surgical_note': 2, 'telemedicine_transcript': 1}`
