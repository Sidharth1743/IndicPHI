...
- sex: `{'Female': 2}`
- zone: `{'Rural': 2}`
- age: min=`21` max=`46` mean=`33.5`
- state_top20: `{'West Bengal': 1, 'Assam': 1}`
- occupation_top20: `{'Market-Oriented Crop and Animal Producers, Other': 1, 'No Occupation / Retired / Homemaker': 1}`
- persona_source_shard: `{'en_IN-00000-of-00011.parquet': 2}`
