...
- timestamp_utc: `2026-07-20T16:03:24.866596+00:00`
...
- sex: `{'Male': 8, 'Female': 15}`
- zone: `{'Rural': 17, 'Urban': 6}`
- age: min=`18` max=`73` mean=`33.869565217391305`
- state_top20: `{'Karnataka': 4, 'Assam': 2, 'Punjab': 2, 'Gujarat': 2, 'Jharkhand': 2, 'Tamil Nadu': 2, 'West Bengal': 1, 'Nagaland': 1, 'Jammu & Kashmir': 1, 'Bihar': 1, 'Kerala': 1, 'Manipur': 1, 'Odisha': 1, 'Uttar Pradesh': 1, 'Andhra Pradesh': 1}`
- occupation_top20: `{'No Occupation / Retired / Homemaker': 11, 'House Keeper (Institutional)': 1, 'Cultivator, Crop': 1, 'Shop Attendant': 1, 'Tailors and Dress Makers, Other': 1, 'Juice Clarification Supervisor': 1, 'Vehicle, Window and Related Cleaners, Other': 1, 'Driver, Bus': 1, 'Senior Officials of Political Party Organisations, Other': 1, 'Security Officer': 1, 'Telemarketing Sales Person': 1, 'Building Construction Labourers, Other': 1, 'Puncher, Metal': 1}`
